...
public class SJMethodImpl extends SJMemberImpl implements SJMethod
{
   ...
   * @generated
   */
  public NotificationChain basicSetBody(SJBlock newBody, NotificationChain msgs)
  {
    SJBlock oldBody = body;
    body = newBody;
   ...
   * @generated
   */
  public void setBody(SJBlock newBody)
  {
    if (newBody != body)
    {
