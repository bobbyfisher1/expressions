...
public class SmallJavaAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected SmallJavaSwitch<Adapter> modelSwitch =
    new SmallJavaSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseSJNamedElement(SJNamedElement object)
      {
        return createSJNamedElementAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.example.smalljava.smallJava.SJNamedElement <em>SJ Named Element</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createSJNamedElementAdapter()
  {
    return null;
  }
