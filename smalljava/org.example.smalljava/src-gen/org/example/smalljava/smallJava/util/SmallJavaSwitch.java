...
public class SmallJavaSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case SmallJavaPackage.SJ_CLASS:
      {
        ...
        if (result == null) result = caseSJNamedElement(sjClass);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case SmallJavaPackage.SJ_MEMBER:
      {
        ...
        if (result == null) result = caseSJNamedElement(sjMember);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case SmallJavaPackage.SJ_FIELD:
      {
        ...
        if (result == null) result = caseSJNamedElement(sjField);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case SmallJavaPackage.SJ_METHOD:
      {
        ...
        if (result == null) result = caseSJNamedElement(sjMethod);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case SmallJavaPackage.SJ_PARAMETER:
      {
        ...
        if (result == null) result = caseSJNamedElement(sjParameter);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case SmallJavaPackage.SJ_VARIABLE_DECLARATION:
      {
        ...
        if (result == null) result = caseSJNamedElement(sjVariableDeclaration);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case SmallJavaPackage.SJ_SYMBOL:
      {
        ...
        if (result == null) result = caseSJNamedElement(sjSymbol);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case SmallJavaPackage.SJ_NAMED_ELEMENT:
      {
        SJNamedElement sjNamedElement = (SJNamedElement)theEObject;
        T result = caseSJNamedElement(sjNamedElement);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>SJ Named Element</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>SJ Named Element</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseSJNamedElement(SJNamedElement object)
  {
    return null;
  }
