...
public class SmallJavaGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class SJProgramElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.example.smalljava.SmallJava.SJProgram");
	...
	public class SJClassElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.example.smalljava.SmallJava.SJClass");
	...
	public class SJMemberElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.example.smalljava.SmallJava.SJMember");
	...
	public class SJFieldElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.example.smalljava.SmallJava.SJField");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SJMethodElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.example.smalljava.SmallJava.SJMethod");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final RuleCall cSJTypedDeclarationParserRuleCall_0 = (RuleCall)cGroup.eContents().get(0);
	...
	public class SJParameterElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.example.smalljava.SmallJava.SJParameter");
	...
	public class SJBlockElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.example.smalljava.SmallJava.SJBlock");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SJStatementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.example.smalljava.SmallJava.SJStatement");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class SJVariableDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.example.smalljava.SmallJava.SJVariableDeclaration");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final RuleCall cSJTypedDeclarationParserRuleCall_0 = (RuleCall)cGroup.eContents().get(0);
	...
	public class SJReturnElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.example.smalljava.SmallJava.SJReturn");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SJIfStatementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.example.smalljava.SmallJava.SJIfStatement");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SJIfBlockElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.example.smalljava.SmallJava.SJIfBlock");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class SJSymbolElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.example.smalljava.SmallJava.SJSymbol");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final RuleCall cSJVariableDeclarationParserRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
	...
	public class SJTypedDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.example.smalljava.SmallJava.SJTypedDeclaration");
	...
	public class SJNamedElementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.example.smalljava.SmallJava.SJNamedElement");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class SJExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.example.smalljava.SmallJava.SJExpression");
	...
	public class SJAssignmentElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.example.smalljava.SmallJava.SJAssignment");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SJSelectionExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.example.smalljava.SmallJava.SJSelectionExpression");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SJTerminalExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.example.smalljava.SmallJava.SJTerminalExpression");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		...
		private final Action cSJNullAction_4_0 = (Action)cGroup_4.eContents().get(0);
		private final Keyword cNullKeyword_4_1 = (Keyword)cGroup_4.eContents().get(1);
		private final Group cGroup_5 = (Group)cAlternatives.eContents().get(5);
		private final Action cSJSymbolRefAction_5_0 = (Action)cGroup_5.eContents().get(0);
		private final Assignment cSymbolAssignment_5_1 = (Assignment)cGroup_5.eContents().get(1);
		private final CrossReference cSymbolSJSymbolCrossReference_5_1_0 = (CrossReference)cSymbolAssignment_5_1.eContents().get(0);
		private final RuleCall cSymbolSJSymbolIDTerminalRuleCall_5_1_0_1 = (RuleCall)cSymbolSJSymbolCrossReference_5_1_0.eContents().get(1);
		private final Group cGroup_6 = (Group)cAlternatives.eContents().get(6);
		private final Action cSJNewAction_6_0 = (Action)cGroup_6.eContents().get(0);
		...
		private final CrossReference cTypeSJClassCrossReference_6_2_0 = (CrossReference)cTypeAssignment_6_2.eContents().get(0);
		private final RuleCall cTypeSJClassIDTerminalRuleCall_6_2_0_1 = (RuleCall)cTypeSJClassCrossReference_6_2_0.eContents().get(1);
		...
		private final RuleCall cSJExpressionParserRuleCall_7_1 = (RuleCall)cGroup_7.eContents().get(1);
		...
		//	| {SJBoolConstant} value=('true' | 'false') | {SJThis} 'this'
		//	| {SJNull} 'null'
		//	| {SJSymbolRef} symbol=[SJSymbol] | {SJNew} 'new' type=[SJClass] '(' ')'
		//	| '(' SJExpression ')';
		@Override public ParserRule getRule() { return rule; }
		
		//{SJStringConstant} value=STRING | {SJIntConstant} value=INT | {SJBoolConstant} value=('true' | 'false') | {SJThis}
		//'this' | {SJNull} 'null' | {SJSymbolRef} symbol=[SJSymbol] | {SJNew} 'new' type=[SJClass] '(' ')' | '(' SJExpression
		//')'
		public Alternatives getAlternatives() { return cAlternatives; }
		...
		//{SJNull}
		public Action getSJNullAction_4_0() { return cSJNullAction_4_0; }
		...
		//{SJSymbolRef}
		public Action getSJSymbolRefAction_5_0() { return cSJSymbolRefAction_5_0; }
		
		//symbol=[SJSymbol]
		public Assignment getSymbolAssignment_5_1() { return cSymbolAssignment_5_1; }
		
		//[SJSymbol]
		public CrossReference getSymbolSJSymbolCrossReference_5_1_0() { return cSymbolSJSymbolCrossReference_5_1_0; }
		
		//ID
		public RuleCall getSymbolSJSymbolIDTerminalRuleCall_5_1_0_1() { return cSymbolSJSymbolIDTerminalRuleCall_5_1_0_1; }
		
		//{SJNew} 'new' type=[SJClass] '(' ')'
		public Group getGroup_6() { return cGroup_6; }
		
		//{SJNew}
		public Action getSJNewAction_6_0() { return cSJNewAction_6_0; }
		...
		//[SJClass]
		public CrossReference getTypeSJClassCrossReference_6_2_0() { return cTypeSJClassCrossReference_6_2_0; }
		
		//ID
		public RuleCall getTypeSJClassIDTerminalRuleCall_6_2_0_1() { return cTypeSJClassIDTerminalRuleCall_6_2_0_1; }
		...
		//SJExpression
		public RuleCall getSJExpressionParserRuleCall_7_1() { return cSJExpressionParserRuleCall_7_1; }
